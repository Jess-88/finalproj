...
// // Calculate and display the savings per week for each milestone
// function calculateSavingsPerWeek() {
//   let totalSavingsPerWeek = 0;

//   for (const milestone of milestones) {
//     const weeksToMilestone = (new Date(milestone.date) - new Date()) / (1000 * 60 * 60 * 24 * 7);
//     const savingsPerWeek = milestone.amount / weeksToMilestone;

//     totalSavingsPerWeek += savingsPerWeek;
//   }

//   return totalSavingsPerWeek;
// }

// const savingsPerWeek = calculateSavingsPerWeek();
...
//   cell.textContent = '$' + savingsPerWeek.toFixed(2);
// }
